...
var bzip2 = require('unbzip2-stream');
...
function Bzip2(from, to) {
    var name = path.basename(from.replace(/\.bz2/, ''));
...
Bzip2.prototype._start = function () {
    ...
    fs.stat(from, function (e, stat) {
        ...
        var unbzip2Stream = bzip2();
        var readStream = fs.createReadStream(from);
        var writeStream = fs.createWriteStream(to);
        var progressStream = _this.getProgressStream();

        pipe([readStream, progressStream, unbzip2Stream, writeStream], function (e) {
            if (e) return _this.emit('error', e);
